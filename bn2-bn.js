...
//Using Binance for Rates Data
function binanceRates() {
$usdngn = $('.usdngnnav');
$gbpngn = $('.gbpngnnav');
$eurngn = $('.eurngnnav');
$cnyngn = $('.cnyngnnav');
...
$.get(baseurl)
    .then(function (data) {
          ...
          //Navbar cryptorates
          if ((data.NGN.BINANCE.btcngn) == '0.00'){$('#btcngnField').val ('...');}else{
          $('#btcngnField').val ($.round(data.NGN.BINANCE.btcngn).toLocaleString('en'));}
          if ((data.NGN.BINANCE.ethngn) == '0.00'){$('#ethngnField').val ('...');}else{
          $('#ethngnField').val ($.round(data.NGN.BINANCE.ethngn).toLocaleString('en'));} 
          if ((data.NGN.BINANCE.bchngn) == '0.00'){$('#bchngnField').val ('...');}else{
          $('#bchngnField').val ($.round(data.NGN.BINANCE.bchngn).toLocaleString('en'));} 
          if ((data.NGN.BINANCE.ltcngn) == '0.00'){$('#ltcngnField').val ('...');}else{
          $('#ltcngnField').val ($.round(data.NGN.BINANCE.ltcngn).toLocaleString('en'));} 
          if ((data.NGN.BINANCE.dashngn) == '0.00'){$('#dashngnField').val ('...');}else{
          $('#dashngnField').val ($.round(data.NGN.BINANCE.dashngn).toLocaleString('en'));} 
          if ((data.NGN.BINANCE.xrpngn) == '0.00'){$('#xrpngnField').val ('...');}else{
          $('#xrpngnField').val ($.round(data.NGN.BINANCE.xrpngn).toLocaleString('en'));} 
          if ((data.NGN.BINANCE.eosngn) == '0.00'){$('#eosngnField').val ('...');}else{
          $('#eosngnField').val ($.round(data.NGN.BINANCE.eosngn).toLocaleString('en'));}
          if ((data.NGN.BINANCE.xlmngn) == '0.00'){$('#xlmngnField').val ('...');}else{
          $('#xlmngnField').val ($.round(data.NGN.BINANCE.xlmngn).toLocaleString('en'));}          
          if ((data.NGN.BINANCE.usdtngn) == '0.00'){$('#usdtngnField').val ('...');}else{
          $('#usdtngnField').val ($.round(data.NGN.BINANCE.usdtngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.adangn) == '0.00'){$('#adangnField').val ('...');}else{
          $('#adangnField').val ($.round(data.NGN.BINANCE.adangn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.xmrngn) == '0.00'){$('#xmrngnField').val ('...');}else{
          $('#xmrngnField').val ($.round(data.NGN.BINANCE.xmrngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.trxngn) == '0.00'){$('#trxngnField').val ('...');}else{
          $('#trxngnField').val ($.round(data.NGN.BINANCE.trxngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.iotangn) == '0.00'){$('#iotangnField').val ('...');}else{
          $('#iotangnField').val ($.round(data.NGN.BINANCE.iotangn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.bnbngn) == '0.00'){$('#bnbngnField').val ('...');}else{
          $('#bnbngnField').val ($.round(data.NGN.BINANCE.bnbngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.neongn) == '0.00'){$('#neongnField').val ('...');}else{
          $('#neongnField').val ($.round(data.NGN.BINANCE.neongn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.etcngn) == '0.00'){$('#etcngnField').val ('...');}else{
          $('#etcngnField').val ($.round(data.NGN.BINANCE.etcngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.xtzngn) == '0.00'){$('#xtzngnField').val ('...');}else{
          $('#xtzngnField').val ($.round(data.NGN.BINANCE.xtzngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.xemngn) == '0.00'){$('#xemngnField').val ('...');}else{
          $('#xemngnField').val ($.round(data.NGN.BINANCE.xemngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.vetngn) == '0.00'){$('#vetngnField').val ('...');}else{
          $('#vetngnField').val ($.round(data.NGN.BINANCE.vetngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.dogengn) == '0.00'){$('#dogengnField').val ('...');}else{
          $('#dogengnField').val ($.round(data.NGN.BINANCE.dogengn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.wavesngn) == '0.00'){$('#wavesngnField').val ('...');}else{
          $('#wavesngnField').val ($.round(data.NGN.BINANCE.wavesngn).toLocaleString('en'));}           
          if ((data.NGN.BINANCE.zecngn) == '0.00'){$('#zecngnField').val ('...');}else{
          $('#zecngnField').val ($.round(data.NGN.BINANCE.zecngn).toLocaleString('en'));}           
          
          
          //Navbar exchange rates 
          if ((data.NGN.BINANCE.usdngn) == '0.00'){$usdngn.html ('...');}else{
          $usdngn.html ('&#8358;'+$.round(data.NGN.BINANCE.usdngn)+'/$');}//&#8358; for Naira html entity
          if ((data.NGN.BINANCE.gbpngn) == '0.00'){$gbpngn.html ('...');}else{
          $gbpngn.html ('&#8358;'+$.round(data.NGN.BINANCE.gbpngn)+'/&#163;');}//&#163; for gbp html entity
          if ((data.NGN.BINANCE.eurngn) == '0.00'){$eurngn.html ('...');}else{
          $eurngn.html ('&#8358;'+$.round(data.NGN.BINANCE.eurngn)+'/&#8364;');}//&#8364; for eur html entity
          if ((data.NGN.BINANCE.cnyngn) == '0.00'){$cnyngn.html ('...');}else{
          $cnyngn.html ('&#8358;'+$.round(data.NGN.BINANCE.cnyngn)+'/&#165;');}//&#165; for cny html entity          
          //update Navbar ticker directions
          if ($.round(data.NGN.BINANCE.usdngn) >= $.round(data.NGN.BINANCE.ystClose_usdngn)){$('.usdngnnavticker').addClass("coin-change-green");$('.usdngnnavticker').removeClass("coin-change-red");}else{$('.usdngnnavticker').removeClass("coin-change-green"); $('.usdngnnavticker').addClass("coin-change-red");}
          if ($.round(data.NGN.BINANCE.gbpngn) >= $.round(data.NGN.BINANCE.ystClose_gbpngn)){$('.gbpngnnavticker').addClass("coin-change-green");$('.gbpngnnavticker').removeClass("coin-change-red");}else{$('.gbpngnnavticker').removeClass("coin-change-green"); $('.gbpngnnavticker').addClass("coin-change-red");}
          if ($.round(data.NGN.BINANCE.eurngn) >= $.round(data.NGN.BINANCE.ystClose_eurngn)){$('.eurngnnavticker').addClass("coin-change-green");$('.eurngnnavticker').removeClass("coin-change-red");}else{$('.eurngnnavticker').removeClass("coin-change-green"); $('.eurngnnavticker').addClass("coin-change-red");}
          if ($.round(data.NGN.BINANCE.cnyngn) >= $.round(data.NGN.BINANCE.ystClose_cnyngn)){$('.cnyngnnavticker').addClass("coin-change-green");$('.cnyngnnavticker').removeClass("coin-change-red");}else{$('.cnyngnnavticker').removeClass("coin-change-green"); $('.cnyngnnavticker').addClass("coin-change-red");}          
   
            //Exchanges page 24 hour volume      
          var binance24hrVolume = ('₦'+$.round(data.NGN.BINANCE.total24hrVolume).toLocaleString('en'));   
       ...
       //   var bitssa24hrVolume = ('₦'+$.round(data.NGN.BITSSA.total24hrVolume).toLocaleString('en'));   
          ...
          if ((data.NGN.BINANCE.total24hrVolume) == '0.00'){$('.binance24hrVolume').html ('...');}else{$('.binance24hrVolume').html (binance24hrVolume);}
     ...
     //     if ((data.NGN.BITSSA.total24hrVolume) == '0.00'){$('.bitssa24hrVolume').html ('...');}else{$('.bitssa24hrVolume').html (bitssa24hrVolume);}
          ...
          var fiatpricebinanceBTCNGN = ('₦'+$.round(data.NGN.BINANCE.btcngn).toLocaleString('en'));
     ...
     //     var fiatpricebitssaBTCNGN = ('₦'+$.round(data.NGN.BITSSA.btcngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.btcngn) == '0.00'){$('.fiatpriceBTCNGN').html ('...');}else{
              $('.fiatpriceBTCNGN').html (fiatpricebinanceBTCNGN);
              $('.fiatpricebinanceBTCNGN').html (fiatpricebinanceBTCNGN);
      ...
      //        $('.fiatpricebitssaBTCNGN').html (fiatpricebitssaBTCNGN);
              ...
              $('.fiatpriceBTCNGN').attr('title', 'Binance:'+fiatpricebinanceBTCNGN+'\nLBC:'+fiatpricelbcBTCNGN);}
          ...
          //Cryptocurrency page Markets
          var fiatpricebinanceETHNGN = ('₦'+$.round(data.NGN.BINANCE.ethngn).toLocaleString('en'));
   ...
   //       var fiatpricebitssaETHNGN = ('₦'+$.round(data.NGN.BITSSA.ethngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.ethngn) == '0.00'){$('.fiatpriceETHNGN').html ('...');}else{
              $('.fiatpriceETHNGN').html (fiatpricebinanceETHNGN);
              $('.fiatpricebinanceETHNGN').html (fiatpricebinanceETHNGN);
   ...
   //           $('.fiatpricebitssaETHNGN').html (fiatpricebitssaETHNGN);
              ...
              $('.fiatpriceETHNGN').attr('title', 'Binance:'+fiatpricebinanceETHNGN+'\nLBC:'+fiatpricelbcETHNGN);}
          ...
          //Cryptocurrency page Markets
          var fiatpricebinanceXRPNGN = ('₦'+$.round(data.NGN.BINANCE.xrpngn).toLocaleString('en'));
   ...
   //       var fiatpricebitssaXRPNGN = ('₦'+$.round(data.NGN.BITSSA.xrpngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.xrpngn) == '0.00'){$('.fiatpriceXRPNGN').html ('...');}else{
              $('.fiatpriceXRPNGN').html (fiatpricebinanceXRPNGN);
              $('.fiatpricebinanceXRPNGN').html (fiatpricebinanceXRPNGN);
   ...
   //           $('.fiatpricebitssaXRPNGN').html (fiatpricebitssaXRPNGN);
              ...
              $('.fiatpriceXRPNGN').attr('title', 'Binance:'+fiatpricebinanceXRPNGN+'\nLBC:'+fiatpricelbcXRPNGN);}
          ...
          /*BCH*/    
          var fiatpricebinanceBCHNGN = ('₦'+$.round(data.NGN.BINANCE.bchngn).toLocaleString('en'));
 ...
 //         var fiatpricebitssaBCHNGN = ('₦'+$.round(data.NGN.BITSSA.bchngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.bchngn) == '0.00'){$('.fiatpriceBCHNGN').html ('...');}else{
              $('.fiatpriceBCHNGN').html (fiatpricebinanceBCHNGN);
   //           $('.fiatpricebitssaBCHNGN').html (fiatpricebitssaBCHNGN);
              $('.fiatpricebtcnairaBCHNGN').html (fiatpricebtcnairaBCHNGN);                
              $('.fiatpriceBCHNGN').attr('title', 'Binance:'+fiatpricebinanceBCHNGN+'\nLBC:'+fiatpricelbcBCHNGN);}
          ...
          /*LTC*/    
          var fiatpricebinanceLTCNGN = ('₦'+$.round(data.NGN.BINANCE.ltcngn).toLocaleString('en'));
  ...
  //        var fiatpricebitssaLTCNGN = ('₦'+$.round(data.NGN.BITSSA.ltcngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.ltcngn) == '0.00'){$('.fiatpriceLTCNGN').html ('...');}else{
              $('.fiatpriceLTCNGN').html (fiatpricebinanceLTCNGN);
   //           $('.fiatpricebitssaLTCNGN').html (fiatpricebitssaLTCNGN);
              $('.fiatpricebtcnairaLTCNGN').html (fiatpricebtcnairaLTCNGN);               
              $('.fiatpriceLTCNGN').attr('title', 'Binance:'+fiatpricebinanceLTCNGN+'\nLBC:'+fiatpricelbcLTCNGN);}
          ...
          /*DASH*/    
          var fiatpricebinanceDASHNGN = ('₦'+$.round(data.NGN.BINANCE.dashngn).toLocaleString('en'));
  ...
  //        var fiatpricebitssaDASHNGN = ('₦'+$.round(data.NGN.BITSSA.dashngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.dashngn) == '0.00'){$('.fiatpriceDASHNGN').html ('...');}else{
              $('.fiatpriceDASHNGN').html (fiatpricebinanceDASHNGN);
   //           $('.fiatpricebitssaDASHNGN').html (fiatpricebitssaDASHNGN);
              $('.fiatpricebtcnairaDASHNGN').html (fiatpricebtcnairaDASHNGN);                
              $('.fiatpriceDASHNGN').attr('title', 'Binance:'+fiatpricebinanceDASHNGN+'\nLBC:'+fiatpricelbcDASHNGN);}
          ...
          /*EOS*/    
          var fiatpricebinanceEOSNGN = ('₦'+$.round(data.NGN.BINANCE.eosngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.eosngn) == '0.00'){$('.fiatpriceEOSNGN').html ('...');}else{
              $('.fiatpriceEOSNGN').html (fiatpricebinanceEOSNGN);
              $('.fiatpriceEOSNGN').attr('title', 'Binance:'+fiatpricebinanceEOSNGN+'\nLBC:'+fiatpricelbcEOSNGN);}
          ...
          /*XLM*/    
          var fiatpricebinanceXLMNGN = ('₦'+$.round(data.NGN.BINANCE.xlmngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.xlmngn) == '0.00'){$('.fiatpriceXLMNGN').html ('...');}else{
              $('.fiatpriceXLMNGN').html (fiatpricebinanceXLMNGN);
              $('.fiatpriceXLMNGN').attr('title', 'Binance:'+fiatpricebinanceXLMNGN+'\nLBC:'+fiatpricelbcXLMNGN);}
          ...
          if ((data.XLM.cap_ngn) == '0.00'){$('.marketcapXLM').html ('...');}else{
              ...
              /*USDT*/    
          var fiatpricebinanceUSDTNGN = ('₦'+$.round(data.NGN.BINANCE.usdtngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.usdtngn) == '0.00'){$('.fiatpriceUSDTNGN').html ('...');}else{
              $('.fiatpriceUSDTNGN').html (fiatpricebinanceUSDTNGN);
              $('.fiatpriceUSDTNGN').attr('title', 'Binance:'+fiatpricebinanceUSDTNGN+'\nLBC:'+fiatpricelbcUSDTNGN);}
          ...
          /*ADA*/    
          var fiatpricebinanceADANGN = ('₦'+$.round(data.NGN.BINANCE.adangn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.adangn) == '0.00'){$('.fiatpriceADANGN').html ('...');}else{
              $('.fiatpriceADANGN').html (fiatpricebinanceADANGN);
              $('.fiatpriceADANGN').attr('title', 'Binance:'+fiatpricebinanceADANGN+'\nLBC:'+fiatpricelbcADANGN);}
          ...
          /*XMR*/    
          var fiatpricebinanceXMRNGN = ('₦'+$.round(data.NGN.BINANCE.xmrngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.xmrngn) == '0.00'){$('.fiatpriceXMRNGN').html ('...');}else{
              $('.fiatpriceXMRNGN').html (fiatpricebinanceXMRNGN);
              $('.fiatpriceXMRNGN').attr('title', 'Binance:'+fiatpricebinanceXMRNGN+'\nLBC:'+fiatpricelbcXMRNGN);}
          ...
          /*TRX*/    
          var fiatpricebinanceTRXNGN = ('₦'+parseFloat(data.NGN.BINANCE.trxngn).toFixed(2));
          ...
          if ((data.NGN.BINANCE.trxngn) == '0.00'){$('.fiatpriceTRXNGN').html ('...');}else{
              $('.fiatpriceTRXNGN').html (fiatpricebinanceTRXNGN);
              $('.fiatpriceTRXNGN').attr('title', 'Binance:'+fiatpricebinanceTRXNGN+'\nLBC:'+fiatpricelbcTRXNGN);}
          ...
          /*IOTA*/    
          var fiatpricebinanceIOTANGN = ('₦'+$.round(data.NGN.BINANCE.iotangn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.iotangn) == '0.00'){$('.fiatpriceIOTANGN').html ('...');}else{
              $('.fiatpriceIOTANGN').html (fiatpricebinanceIOTANGN);
              $('.fiatpriceIOTANGN').attr('title', 'Binance:'+fiatpricebinanceIOTANGN+'\nLBC:'+fiatpricelbcIOTANGN);}
          ...
          /*BNB*/    
          var fiatpricebinanceBNBNGN = ('₦'+$.round(data.NGN.BINANCE.bnbngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.bnbngn) == '0.00'){$('.fiatpriceBNBNGN').html ('...');}else{
              $('.fiatpriceBNBNGN').html (fiatpricebinanceBNBNGN);
              $('.fiatpriceBNBNGN').attr('title', 'Binance:'+fiatpricebinanceBNBNGN+'\nLBC:'+fiatpricelbcBNBNGN);}
          ...
          /*NEO*/    
          var fiatpricebinanceNEONGN = ('₦'+$.round(data.NGN.BINANCE.neongn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.neongn) == '0.00'){$('.fiatpriceNEONGN').html ('...');}else{
              $('.fiatpriceNEONGN').html (fiatpricebinanceNEONGN);
              $('.fiatpriceNEONGN').attr('title', 'Binance:'+fiatpricebinanceNEONGN+'\nLBC:'+fiatpricelbcNEONGN);}
          ...
          /*ETC*/    
          var fiatpricebinanceETCNGN = ('₦'+$.round(data.NGN.BINANCE.etcngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.etcngn) == '0.00'){$('.fiatpriceETCNGN').html ('...');}else{
              $('.fiatpriceETCNGN').html (fiatpricebinanceETCNGN);
              $('.fiatpriceETCNGN').attr('title', 'Binance:'+fiatpricebinanceETCNGN+'\nLBC:'+fiatpricelbcETCNGN);}
          ...
          /*XTZ*/    
          var fiatpricebinanceXTZNGN = ('₦'+$.round(data.NGN.BINANCE.xtzngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.xtzngn) == '0.00'){$('.fiatpriceXTZNGN').html ('...');}else{
              $('.fiatpriceXTZNGN').html (fiatpricebinanceXTZNGN);
              $('.fiatpriceXTZNGN').attr('title', 'Binance:'+fiatpricebinanceXTZNGN+'\nLBC:'+fiatpricelbcXTZNGN);}
          ...
          /*XEM*/    
          var fiatpricebinanceXEMNGN = ('₦'+$.round(data.NGN.BINANCE.xemngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.xemngn) == '0.00'){$('.fiatpriceXEMNGN').html ('...');}else{
              $('.fiatpriceXEMNGN').html (fiatpricebinanceXEMNGN);
              $('.fiatpriceXEMNGN').attr('title', 'Binance:'+fiatpricebinanceXEMNGN+'\nLBC:'+fiatpricelbcXEMNGN);}
          ...
          /*VET*/    
          var fiatpricebinanceVETNGN = ('₦'+parseFloat(data.NGN.BINANCE.vetngn).toFixed(2));
          ...
          if ((data.NGN.BINANCE.vetngn) == '0.00'){$('.fiatpriceVETNGN').html ('...');}else{
              $('.fiatpriceVETNGN').html (fiatpricebinanceVETNGN);
              $('.fiatpriceVETNGN').attr('title', 'Binance:'+fiatpricebinanceVETNGN+'\nLBC:'+fiatpricelbcVETNGN);}
          ...
          /*DOGE*/    
          var fiatpricebinanceDOGENGN = ('₦'+parseFloat(data.NGN.BINANCE.dogengn).toFixed(2));
          ...
          if ((data.NGN.BINANCE.dogengn) == '0.00'){$('.fiatpriceDOGENGN').html ('...');}else{
              $('.fiatpriceDOGENGN').html (fiatpricebinanceDOGENGN);
              $('.fiatpriceDOGENGN').attr('title', 'Binance:'+fiatpricebinanceDOGENGN+'\nLBC:'+fiatpricelbcDOGENGN);}
          ...
          /*WAVES*/    
          var fiatpricebinanceWAVESNGN = ('₦'+parseFloat(data.NGN.BINANCE.wavesngn).toFixed(2));
          ...
          if ((data.NGN.BINANCE.wavesngn) == '0.00'){$('.fiatpriceWAVESNGN').html ('...');}else{
              $('.fiatpriceWAVESNGN').html (fiatpricebinanceWAVESNGN);
              $('.fiatpriceWAVESNGN').attr('title', 'Binance:'+fiatpricebinanceWAVESNGN+'\nLBC:'+fiatpricelbcWAVESNGN);}
          ...
          /*ZEC*/    
          var fiatpricebinanceZECNGN = ('₦'+$.round(data.NGN.BINANCE.zecngn).toLocaleString('en'));
          ...
          if ((data.NGN.BINANCE.zecngn) == '0.00'){$('.fiatpriceZECNGN').html ('...');}else{
              $('.fiatpriceZECNGN').html (fiatpricebinanceZECNGN);
              $('.fiatpriceZECNGN').attr('title', 'Binance:'+fiatpricebinanceZECNGN+'\nLBC:'+fiatpricelbcZECNGN);}
        ...
        //Update BTCNaira Fee
         ...
         if ((data.NGN.BINANCE.total24hrVolume) == '0.00'){$('#exchanges').find('.binance .coin-symbol.24hrvolume').html ('...');$('#cryptopagetable').find('.binance-btcngn .coin-symbol.24hrvolume').html ('...');}else{
              $('#exchanges').find('.binance .coin-symbol.24hrvolume').html ('&#8358;'+marketcapFormatter(data.NGN.BINANCE.total24hrVolume, 2));
              $('#exchanges').find('.binance .coin-symbol.24hrvolume').attr("data-order",data.NGN.BINANCE.total24hrVolume);
              $('#cryptopagetable').find('.binance-btcngn .coin-symbol.24hrvolume').html ('&#8358;'+marketcapFormatter(data.NGN.BINANCE.btcngn24hrVolume, 2));
              $('#cryptopagetable').find('.binance-btcngn .coin-symbol.24hrvolume').attr("data-order",data.NGN.BINANCE.btcngn24hrVolume);
         }
  /*       if ((data.NGN.BITSSA.total24hrVolume) == '0.00'){$('#exchanges').find('.bitssa .coin-symbol.24hrvolume').html ('...');$('#cryptopagetable').find('.bitssa-btcngn .coin-symbol.24hrvolume').html ('...');}else{
        ...
        if ((data.NGN.REMITANO.total24hrVolume) == '0.00'){$('#exchanges').find('.remitano .coin-symbol.24hrvolume').html ('...');$('#cryptopagetable').find('.remitano-btcngn .coin-symbol.24hrvolume').html ('...');}else{
          $('#exchanges').find('.remitano .coin-symbol.24hrvolume').html ('&#8358;'+marketcapFormatter(data.NGN.REMITANO.total24hrVolume, 2));
             ...
             $('.totalBTCNGN24hrvolume').html('&#8358;'+(parseInt(data.NGN.BINANCE.btcngn24hrVolume)/* + parseInt(data.NGN.BITSSA.btcngn24hrVolume) */+ parseInt(data.NGN.LOCALBITCOIN.btcngn24hrVolume) + parseInt(data.NGN.REMITANO.btcngn24hrVolume)).toLocaleString('en'));
             //Total ETHNGN 24hour volume for all exchanges
             $('.totalETHNGN24hrvolume').html('&#8358;'+(parseInt(data.NGN.BINANCE.ethngn24hrVolume) + parseInt(data.NGN.REMITANO.ethngn24hrVolume)).toLocaleString('en'));
...
//Use Binance Rates Data on default
setInterval(binanceRates, 60000)
binanceRates();
...
var bnbpagelink = document.location.origin+'/2018/10/binance-coin.html';
...
var binancelogolink = 'https://1.bp.blogspot.com/-fdhqxmsGGXU/W5a-IzVJZbI/AAAAAAAABMs/5V4TPhxJmAMrBYlAeXQg-zBH2lNljnu9QCLcBGAs/s1600/binance.png';
...
$('.binancelogolink').attr('src',binancelogolink);  
...
var binancepagelink = document.location.origin+'/p/binance.html';
...
$('.binancepagelink').attr('href',binancepagelink);  
...
var binancereviewlink = document.location.origin+'/p/binance.html#reviews';
...
$('.binancereviewlink').attr('href',binancereviewlink);  
...
var binancewebsitelink = 'https://www.binance.com';
...
$('.binancewebsitelink').attr('href',binancewebsitelink);  
